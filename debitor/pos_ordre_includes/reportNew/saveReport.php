...
{
    db_modify("INSERT INTO report (date, type, description, count, report_number, total, report_type) values
    ('$date', '$type', '$descr', $count, '$repNr', $total, 'Z')", __FILE__ . "linje" . __LINE__);
}
