...
function showDeletedOrders()
{
    ...
    print "<center><table id=\"getOrderTable\">";
      print "<div style=\"margin-left: -400px\">
                ...
                <b style=\"font-size:40px;\"> Slettede bestillinger </b>
            </div>";
	...
	print "<tbody style=\"margin-buttom: 20px;\">
		<tr>
			  ...
			  <button style=\"margin-right: 10px;\" disabled class=\"historyButton detailButton\" type=\"submit\" name=\"submit\" value=\"reviveOrder\">
				Genskab ordre
			  </button>
			  <button disabled class=\"historyButton detailButton\" type=\"submit\" name=\"submit\" value=\"permanentDelete\">
				Slet permanent
			  </button>
		</tr>
	</tbody>";
	...
	print "<tbody id=\"tbodyData\">";
          ...
          print "</div>
                    ...
                    <td class=\"infoLine\">
                          <div class='historyInfo'>";
          if ($value['betalt'] == "no") { print "Nej"; } else { print $value['betalt']; }
          print "</div>
                    </td>
                    <td class=\"infoLine\">
                          <div class='historyInfo'>";
