...
print "<tr><td align=center><big>Du er ved at rette salgspris fra:<br><br><b>". $oldSalesPrice ."</b><br><br>til:<br><br><b>". $salgspris ."</b> !</big></td></tr>";
...
if (strpos($salgspris,"'")) print "value=\"$salgspris\"";
else print "value='$salgspris'";
print "></td></tr>";
