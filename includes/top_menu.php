...
print "				<li>\n";
print "					<a href=\"#\" class=\"navbarlink ".$site_names['finans']."\">Finans</a>\n";
...
print "				</li>\n";
print "				<li>\n";
print "					<a href=\"#\" class=\"navbarlink ".$site_names['debitor']."\">Kunder</a>\n";
print "					<ul class=\"subnavbar\">\n";
...
print "				</li>\n";
print "				<li>\n";
print "					<a href=\"#\" class=\"navbarlink ".$site_names['kreditor']."\">Leverandører</a>\n";
print "					<ul class=\"subnavbar\">\n";
...
print "						<li><a href=\"../lager/varemodtagelse.php\">Varemodtagelse\"</a></li>\n";
print "						<li><a href=\"#\">Rapporter</a></li>\n";
print "					</ul>\n";
print "				</li>\n";
print "				<li>\n";
...
print "						<li><a href=\"../systemdata/syssetup.php\">Instillinger</a></li>\n";
...
print "						<li><a href=\"#\">Vejledning</a></li>\n";
print "						<li><a href=\"#\">Instillinger</a></li>\n";
