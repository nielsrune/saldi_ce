<?php
// ----------finans/importer.php------------patch 3.0.6-----2010.09.26-----------
// LICENS
//
...
#		$kontonr=$_POST['kontonr'];
	...
	if (basename($_FILES['uploadedfile']['name'])) {
		...
		if ($r=db_fetch_array(db_select("select * from grupper where ART = 'KASKL' and kode='2' and kodenr='$bruger_id'",__FILE__ . " linje " . __LINE__))) {
			...
			$feltnavn[0]=if_isset($r['box2']);
			$feltnavn[1]=if_isset($r['box3']);
			$feltnavn[2]=if_isset($r['box4']);
			$feltnavn[3]=if_isset($r['box5']);
			$feltnavn[4]=if_isset($r['box6']);
			$feltnavn[5]=if_isset($r['box7']);
			$feltnavn[6]=if_isset($r['box8']);
			$feltnavn[7]=if_isset($r['box9']);
			$feltnavn[8]=if_isset($r['box10']);
		} else {
...
print "<tr><td width=100% align=center>Import af bankposteringer</td></tr>";
...
print "<tr><td width=100% align=center><br></td></tr>";
print "<tr><td width=100% align=center>Import af andre data</td></tr>";
print "<tr><td width=100% align=center><br></td></tr>";
