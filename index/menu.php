...
#	$leftbutton="<a><br></a>";
#	$rightbutton="<a href=\"../index/logud.php\">Afslut</a>";
...
#print "<table style=\"width:100%;height:100%;#position:absolute;\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tbody>\n";
#print "<div style=\"width:980px; height:150px; background-color:#04acec;\"></div>";
...
print	"</td></tr>\n";
print	"<tr><td align=\"center\" valign=\"bottom\">\n";
print "<div class=top_bund><small>SALDI&nbsp;version&nbsp;$version&nbsp;-&nbsp;Copyright&nbsp;&copy;&nbsp;2003-2012&nbsp;DANOSOFT&nbsp;aps</small></div></td></tr>\n";
print	"</tbody></table>\n";
$query = db_select("select * from grupper where art = 'RA'",__FILE__ . " linje " . __LINE__);
if (!$row = db_fetch_array($query)) {
	if ($popup) print "<body onLoad=\"JavaScript:regnaar=window.open('../systemdata/regnskabsaar.php?returside=../includes/luk.php','regnaar',',.$jsvars.,alwaysraised=yes');regnaar.focus();regnaar.focus();\">\n";
